 ...
 */
static inline const StrT vFormat(const char* const p_zcFormat, ...) {
...
public:
    string operator()(const bool                   v, const string       ) const {
                                                      string fmt = OPTIONS->PrintBoolAsString() ? "%5s" : "%1s";
                                                      string vS  = OPTIONS->PrintBoolAsString() ? (v ? "TRUE " : "FALSE") : (v ? "1" : "0");
                                                      return vFormat(fmt.c_str(), vS.c_str());
                                                   }
    string operator()(const int                    v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), v); }
    string operator()(const short int              v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), v); }
    string operator()(const long int               v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), v); }
    string operator()(const long long int          v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), v); }
    string operator()(const unsigned int           v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "u"; return vFormat(fmt.c_str(), v); }
    string operator()(const unsigned short int     v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "u"; return vFormat(fmt.c_str(), v); }
    string operator()(const unsigned long int      v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "u"; return vFormat(fmt.c_str(), v); } // also handles OBJECT_ID (typedef)
    string operator()(const unsigned long long int v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "u"; return vFormat(fmt.c_str(), v); }
    string operator()(const float                  v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "f"; return vFormat(fmt.c_str(), v); }
    string operator()(const double                 v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "f"; return vFormat(fmt.c_str(), v); }
    string operator()(const CDOUBLE                v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "f"; return vFormat(fmt.c_str(), v.Value()); }    // extract underlying double via Value(); CDOUBLE is not varargs-safe
    string operator()(const long double            v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "f"; return vFormat(fmt.c_str(), v); }
    string operator()(const string                 v, const string fmtStr) const { string fmt = fmtStr; fmt = "%-" + fmt + "s"; return vFormat(fmt.c_str(), v.c_str()); }
    string operator()(const ERROR                  v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const STELLAR_TYPE           v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const MT_CASE                v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const MT_TRACKING            v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const MT_TIMESCALE           v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const SN_EVENT               v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const SN_STATE               v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const EVOLUTION_STATUS       v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const STR_VECTOR             v, const string fmtStr) const { string fmt = fmtStr; fmt = "%-" + fmt + "s"; return vFormat(fmt.c_str(), v[0].c_str()); }
    string operator()(const STR_VECTOR             v, const string fmtStr, const size_t idx) const { string fmt = fmtStr; fmt = "%-" + fmt + "s"; return vFormat(fmt.c_str(), v[idx].c_str()); }
    string operator()(const DBL_VECTOR             v, const string fmtStr) const { string fmt = fmtStr; fmt = "%"  + fmt + "f"; return vFormat(fmt.c_str(), v[0]); }
    string operator()(const DBL_VECTOR             v, const string fmtStr, const size_t idx) const { string fmt = fmtStr; fmt = "%"  + fmt + "f"; return vFormat(fmt.c_str(), v[idx]); }
};
...
public:
    ...
    string operator()(const int                    v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), v); }
    string operator()(const short int              v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), v); }
    string operator()(const long int               v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), v); }
    string operator()(const long long int          v) const { string fmt = "%28.1d"; return vFormat(fmt.c_str(), v); }
    string operator()(const unsigned int           v) const { string fmt = "%14.1u"; return vFormat(fmt.c_str(), v); }
    string operator()(const unsigned short int     v) const { string fmt = "%14.1u"; return vFormat(fmt.c_str(), v); }
    string operator()(const unsigned long int      v) const { string fmt = "%14.1u"; return vFormat(fmt.c_str(), v); } // also handles OBJECT_ID (typedef)
    string operator()(const unsigned long long int v) const { string fmt = "%28.1u"; return vFormat(fmt.c_str(), v); }
    string operator()(const float                  v) const { string fmt = "%16.8e"; return vFormat(fmt.c_str(), v); }
    string operator()(const double                 v) const { string fmt = "%16.8e"; return vFormat(fmt.c_str(), v); }
    string operator()(const CDOUBLE                v) const { string fmt = "%16.8e"; return vFormat(fmt.c_str(), v.Value()); }   // extract underlying double via Value(); CDOUBLE is not varargs-safe
    string operator()(const long double            v) const { string fmt = "%16.8e"; return vFormat(fmt.c_str(), v); }
    string operator()(const string                 v) const { string fmt = "%-30s";  return vFormat(fmt.c_str(), v.c_str()); }
    string operator()(const ERROR                  v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const STELLAR_TYPE           v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const MT_CASE                v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const MT_TRACKING            v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const MT_TIMESCALE           v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const SN_EVENT               v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const SN_STATE               v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const EVOLUTION_STATUS       v) const { string fmt = "%14.1d"; return vFormat(fmt.c_str(), static_cast<int>(v)); }
    string operator()(const STR_VECTOR             v) const { string fmt = "%-30s"; return vFormat(fmt.c_str(), v[0].c_str()); }
    string operator()(const STR_VECTOR             v, const size_t idx) const { string fmt ="%-30s"; return vFormat(fmt.c_str(), v[idx].c_str()); }
    string operator()(const DBL_VECTOR             v) const { string fmt = "%16.8e"; return vFormat(fmt.c_str(), v[0]); }
    string operator()(const DBL_VECTOR             v, const size_t idx) const { string fmt = "%16.8e"; return vFormat(fmt.c_str(), v[idx]); }
};
...
private:
    ...
    Log() {                                                                         // constructor - initialise variables
        m_Files.Enabled                     = false;                                      // logging disabled initially
        m_Hdf5.ContainerId             = -1;                                         // no HDF5 container file open initially
        m_Hdf5.RunDetailsFile.fileId  = -1;                                         // no HDF5 file id for run details file initially
        m_Hdf5.RunDetailsFile.groupId = -1;                                         // no HDF5 group id for run details file initially
        m_Hdf5.DetailedId              = -1;                                         // no HDF5 detailed file open initially
        m_Config.LogBasePathString           = ".";                                        // default log file base path string (CWD)
        m_Config.LogPathsCreated             = {};                                         // assume already exists (for now)
        m_Config.LogContainerName            = DEFAULT_OUTPUT_CONTAINER_NAME;              // default log file container name                        
        m_Config.LogNamePrefix               = "";                                         // default log file name prefix
        m_Config.LogfileType                 = DEFAULT_LOGFILE_TYPE;                       // default log file type
        m_Config.LogLevel                    = 0;                                          // default log level - log everything
        m_Config.LogClasses                  = {};                                         // no default log classes
        m_Config.DbgLevel                    = 0;                                          // default debug level - debug everything
        m_Config.DbgClasses                  = {};                                         // no default debug classes
        m_Config.DbgToLogfile                = false;                                      // default is not to log debug records to the log file
        m_Config.DbgLogfileId                = -1;                                         // default is not valid
        m_Files.Logfiles.clear();                                                         // default is no log files
        m_Files.OpenStandardLogFileIds      = {};                                         // no open COMPAS standard log files

        m_SwitchLog.ObjectIdSwitching           = -1L;                                        // object id of the Star object switching stellar type - default none
        m_SwitchLog.ObjectSwitchingType         = OBJECT_TYPE::NONE;                          // object type of the Star object switching stellar type - default NONE
        m_SwitchLog.ObjectSwitchingPersistence  = OBJECT_PERSISTENCE::PERMANENT;              // object persistence of the Star object switching stellar type - default permanent
        m_SwitchLog.TypeSwitchingFrom           = STELLAR_TYPE::NONE;                         // stellar type from which the Star object is switching - default NONE
        m_SwitchLog.TypeSwitchingTo             = STELLAR_TYPE::NONE;                         // stellar type to which the Star object is switching - default NONE
        m_SwitchLog.PrimarySwitching            = false;                                      // Star switching is primary star of binary - default false
        m_SwitchLog.SwitchIsMerger              = false;                                      // Switchlog record records a merger (rather than a simple switch)
...
*/
        ...
        m_Config.OptionDetails = {};                                                       // option details retrieved from commandline - initially empty
    };
    ...
    // member variables
    //
    //   m_Config    - setup-time settings: paths, naming, levels, classes,
    //                 OptionDetails. Populated by Log::Start() and read
    //                 throughout the logging code.
    //
    //   m_Files     - runtime file handles, timing, and the Enabled flag.
    //                 Tracks what's currently open and when.
    //
    //   m_Hdf5      - HDF5-specific state: container ids, detailed-output id,
    //                 run-details file group/ids.
    //
    //   m_Specs     - BSE and SSE logfile record specifications and the
    //                 corresponding annotation flag vectors (`*_Notes`).
    //                 These describe WHAT each logfile records.
    //
    //   m_SwitchLog - state captured when a stellar-type switch happens,
    //                 consumed when the switchlog record is written.
    //


    // Type definitions used by the themed structs below.
    ...
    // ---------------------------------------------------------------------------
    // m_Config - setup-time settings.
    // ---------------------------------------------------------------------------

    struct ConfigState {
        string                      LogBasePathString;                              // base path string for log files
        STR_VECTOR                  LogPathsCreated;                                // vector of directories created for logging (may be empty if pre-existing)
        string                      LogContainerName;                               // container (directory) name for log files
        string                      LogNamePrefix;                                  // prefix for log files

        LOGFILETYPE                 LogfileType;                                    // logfile type
        int                         LogLevel;                                       // log level
        std::vector<string>         LogClasses;                                     // log classes

        int                         DbgLevel;                                       // debug level
        std::vector<string>         DbgClasses;                                     // debug classes
        bool                        DbgToLogfile;                                   // log debug records to log file?
        int                         DbgLogfileId;                                   // log file id of file to which debug statements should be written

        bool                        ErrToLogfile;                                   // log error records to log file?
        int                         ErrLogfileId;                                   // log file id of file to which error statements should be written

        std::vector<OptionDetailsT> OptionDetails;                                  // option details retrieved from commandline
    };
    ConfigState m_Config;


    // ---------------------------------------------------------------------------
    // m_Files - runtime file handles, timing, and lifecycle.
    // ---------------------------------------------------------------------------

    struct FilesState {
        bool                                               Enabled;                 // is logging enabled?
        std::vector<logfileAttrT>                          Logfiles;                // logfiles - in use and not
        COMPASUnorderedMap<LOGFILE, LogfileDetailsT>       OpenStandardLogFileIds;  // currently open standard logfiles: id, filename, property details, field format strings
        std::ofstream                                      RunDetailsFile;          // run details file (CSV/TSV/TXT)
        std::chrono::time_point<std::chrono::system_clock> WallStart;               // for run details file
        std::chrono::time_point<std::chrono::system_clock> WallEnd;                 // for run details file
        clock_t                                            ClockStart;              // for run details file
    };
    FilesState m_Files;


    // ---------------------------------------------------------------------------
    // m_Hdf5 - HDF5-specific state.
    // ---------------------------------------------------------------------------

    struct Hdf5State {
        string  ContainerName;                                                      // HDF5 container name
        hid_t   ContainerId;                                                        // HDF5 container id
        hid_t   DetailedId;                                                         // HDF5 detailed output id
        h5AttrT RunDetailsFile;                                                     // HDF5 attributes for run details record in HDF5 container
    };
    Hdf5State m_Hdf5;


    // ---------------------------------------------------------------------------
    // m_Specs - BSE/SSE logfile record specifications and annotation flags.
    //
    // The `*_Notes` vectors are sized to OPTIONS->NotesHdrs().size() and
    // initialised to all-false. Log::Start() updates them based on whether
    // PROGRAM_OPTION::NOTES appears in the corresponding record spec; this is
    // so Log::UpdateAllLogfileRecordSpecs() has the right defaults when
    // processing a log-definitions file.
    // ---------------------------------------------------------------------------

    struct SpecsState {
        // BSE record specs
        ANY_PROPERTY_VECTOR BSE_CEE_Rec          = BSE_COMMON_ENVELOPES_REC;
        ANY_PROPERTY_VECTOR BSE_DCO_Rec          = BSE_DOUBLE_COMPACT_OBJECTS_REC;
        ANY_PROPERTY_VECTOR BSE_Detailed_Rec     = BSE_DETAILED_OUTPUT_REC;
        ANY_PROPERTY_VECTOR BSE_Pulsars_Rec      = BSE_PULSAR_EVOLUTION_REC;
        ANY_PROPERTY_VECTOR BSE_RLOF_Rec         = BSE_RLOF_PARAMETERS_REC;
        ANY_PROPERTY_VECTOR BSE_SNE_Rec          = BSE_SUPERNOVAE_REC;
        ANY_PROPERTY_VECTOR BSE_Switch_Rec       = BSE_SWITCH_LOG_REC;
        ANY_PROPERTY_VECTOR BSE_SysParms_Rec     = BSE_SYSTEM_PARAMETERS_REC;
        ANY_PROPERTY_VECTOR BSE_Sys_Snapshot_Rec = BSE_SYSTEM_SNAPSHOT_LOG_REC;

        // SSE record specs
        ANY_PROPERTY_VECTOR SSE_Detailed_Rec     = SSE_DETAILED_OUTPUT_REC;
        ANY_PROPERTY_VECTOR SSE_Pulsars_Rec      = SSE_PULSAR_EVOLUTION_REC;
        ANY_PROPERTY_VECTOR SSE_SNE_Rec          = SSE_SUPERNOVAE_REC;
        ANY_PROPERTY_VECTOR SSE_Switch_Rec       = SSE_SWITCH_LOG_REC;
        ANY_PROPERTY_VECTOR SSE_SysParms_Rec     = SSE_SYSTEM_PARAMETERS_REC;
        ANY_PROPERTY_VECTOR SSE_Sys_Snapshot_Rec = SSE_SYSTEM_SNAPSHOT_LOG_REC;

        // BSE annotation flags
        BOOL_VECTOR BSE_CEE_Notes          = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_DCO_Notes          = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_Detailed_Notes     = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_Pulsars_Notes      = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_RLOF_Notes         = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_SNE_Notes          = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_Switch_Notes       = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_SysParms_Notes     = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR BSE_Sys_Snapshot_Notes = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);

        // SSE annotation flags
        BOOL_VECTOR SSE_Detailed_Notes     = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR SSE_Pulsars_Notes      = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR SSE_SNE_Notes          = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR SSE_Switch_Notes       = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR SSE_SysParms_Notes     = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
        BOOL_VECTOR SSE_Sys_Snapshot_Notes = BOOL_VECTOR(OPTIONS->NotesHdrs().size(), false);
    };
    SpecsState m_Specs;


    // ---------------------------------------------------------------------------
    // m_SwitchLog - state captured when a stellar-type switch occurs;
    // consumed when the switchlog record is written.
    // ---------------------------------------------------------------------------

    struct SwitchLogState {
        OBJECT_ID          ObjectIdSwitching;                                       // the object id of the Star object switching stellar type
        OBJECT_TYPE        ObjectSwitchingType;                                     // the object type of the Star object switching stellar type
        OBJECT_PERSISTENCE ObjectSwitchingPersistence;                              // the object persistence of the Star object switching stellar type
        STELLAR_TYPE       TypeSwitchingFrom;                                       // the stellar type from which the Star object is switching
        STELLAR_TYPE       TypeSwitchingTo;                                         // the stellar type to which the Star object is switching
        bool               PrimarySwitching;                                        // flag to indicate whether the primary star of the binary is switching
        bool               SwitchIsMerger;                                          // flag to indicate whether the switchlog record records a merger (rather than a simple switch)
    };
    SwitchLogState m_SwitchLog;


    // ---------------------------------------------------------------------------
    // The following struct (commented out) was an experimental design for
    // delayed writes to logfiles. Only delayed writes to the SSE Supernova
    // file were ever implemented, and only a single record could be delayed.
    // The functionality was introduced specifically to allow queueing a
    // delayed write to the SSE Supernova file - see the discussion in the
    // description of Log::GetStandardLogFileRecordDetails() in Log.cpp.
    //
    // Preserved here for reference; not part of any themed struct.
    // ---------------------------------------------------------------------------
    /*
    struct delayedWriteDetailsT {
        LOGRECORDTYPE          logRecordType;
        string                 logRecordString;
        COMPAS_VARIABLE_VECTOR logRecordValues;
        ANY_PROPERTY_VECTOR    logRecordProperties;
        STR_VECTOR             logRecordFmtVector;
        BOOL_VECTOR            logFileAnnotations;
    };

    delayedWriteDetailsT m_SSESupernovae_DelayedWrite;
    */


    // member functions

    bool IsValidId(const int p_LogfileId)    { return ((p_LogfileId >= 0) && ((unsigned int)p_LogfileId < m_Files.Logfiles.size())); }
    bool IsActiveId(const int p_LogfileId)   { return IsValidId(p_LogfileId) && m_Files.Logfiles[p_LogfileId].active; }

    void ClearEntry(const int p_LogfileId) {
        if (IsValidId(p_LogfileId)) {
            m_Files.Logfiles[p_LogfileId].active          = false;                        // not active
            m_Files.Logfiles[p_LogfileId].logfiletype     = LOGFILE::NONE;
            m_Files.Logfiles[p_LogfileId].filetype        = OPTIONS->LogfileType();
            m_Files.Logfiles[p_LogfileId].name            = "";
            m_Files.Logfiles[p_LogfileId].timestamp       = false;
            m_Files.Logfiles[p_LogfileId].label           = false;
            m_Files.Logfiles[p_LogfileId].h5File.fileId   = -1;
            m_Files.Logfiles[p_LogfileId].h5File.groupId  = -1;
            m_Files.Logfiles[p_LogfileId].h5File.dataSets = {};
        }
    }
    ...
    std::tuple<std::string, COMPAS_VARIABLE_VECTOR> GetLogStandardRecord(const LOGFILE             p_LogFile,
        ...
        if (ok) {
            ...
            if (p_LogFile == LOGFILE::BSE_SWITCH_LOG) {
                int starSwitching = m_SwitchLog.PrimarySwitching ? 1 : 2;                                                                 // primary (1) or secondary (2)
                if (hdf5) {                                                                                                     // yes - HDF5 file?
                    logRecordValues.push_back(starSwitching);                                                                   // yes - add value to vector of values
                }
                else {                                                                                                          // no - CSV, TSV, or TXT file
                    logRecord += vFormat(fmtStr.c_str(), starSwitching) + delimiter;                                     // add value string to log record - with delimiter
                }
            }

            if (p_LogFile == LOGFILE::BSE_SWITCH_LOG || p_LogFile == LOGFILE::SSE_SWITCH_LOG) {
                if (hdf5) {                                                                                                     // HDF5 file?
                    logRecordValues.push_back(m_SwitchLog.TypeSwitchingFrom);                                                             // yes - add value to vector of values
                }
                else {                                                                                                          // no - CSV, TSV, or TXT file
                    logRecord += vFormat(fmtStr.c_str(), m_SwitchLog.TypeSwitchingFrom) + delimiter;                               // add value string to log record - with delimiter
                }

                if (hdf5) {                                                                                                     // HDF5 file?
                    logRecordValues.push_back(m_SwitchLog.TypeSwitchingTo);                                                               // yes - add value to vector of values
                }
                else {                                                                                                          // no - CSV, TSV, or TXT file
                    logRecord += vFormat(fmtStr.c_str(), m_SwitchLog.TypeSwitchingTo) + delimiter;                                 // add value string to log record - with delimiter
                }
            }

            if (p_LogFile == LOGFILE::BSE_SWITCH_LOG) {
                if (hdf5) {                                                                                                     // HDF5 file?
                    logRecordValues.push_back(m_SwitchLog.SwitchIsMerger);                                                                // yes - add value to vector of values
                }
                else {                                                                                                          // no - CSV, TSV, or TXT file
                    logRecord += vFormat(fmtStr.c_str(), m_SwitchLog.SwitchIsMerger) + delimiter;                                  // add value string to log record - with delimiter
                }
            }
            ...
            if (p_LogFile != LOGFILE::BSE_SWITCH_LOG && p_LogFile != LOGFILE::SSE_SWITCH_LOG) {                                 // switch file?
                ...
                if (hdf5) {                                                                                                     // HDF5 file?
                    ...
                    logRecord += vFormat(fmtStr.c_str(), p_RecordType);                                                  // add value string to log record
                }
            }
        }
    ...
    bool LogStandardRecord(const string        p_LogClass,
        ...
        if (fileDetails.id >= 0) {                                                                                          // file open?
            if ((p_RecordType & fileDetails.recordTypes) > 0) {                                                             // yes - record type enabled?
                                                                                                                            // yes - proceed
                if (m_Files.Logfiles[fileDetails.id].filetype == LOGFILETYPE::HDF5) {                                             // HDF5 file?
...
public:
    ...
    // True between completion of Instance()'s first construction call and the
    // start of ~Log(). Use to avoid touching the singleton during static init
    // (before its first Instance() call) or static destruction (after ~Log()
    // has begun), where the underlying state may not be valid.
    ...
    bool   Enabled() const { return m_Files.Enabled; }
    ...
    void   SetSwitchParameters(const OBJECT_ID          p_ObjectIdSwitching,
        ...
        m_SwitchLog.ObjectIdSwitching          = p_ObjectIdSwitching;                         // the object id of the Star object switching stellar type
        m_SwitchLog.ObjectSwitchingType        = p_ObjectSwitchingType;                       // the object type of the Star object switching stellar type
        m_SwitchLog.ObjectSwitchingPersistence = p_ObjectSwitchingPersistence;                // the object persistence of the Star object switching stellar type
        m_SwitchLog.TypeSwitchingFrom          = p_TypeSwitchingFrom;                         // the stellar type from which the Star object is switching
        m_SwitchLog.TypeSwitchingTo            = p_TypeSwitchingTo;                           // the stellar type to which the Star object is switching
    }

    OBJECT_ID          ObjectIdSwitching()          { return m_SwitchLog.ObjectIdSwitching; }
    OBJECT_TYPE        ObjectSwitchingType()        { return m_SwitchLog.ObjectSwitchingType; }
    OBJECT_PERSISTENCE ObjectSwitchingPersistence() { return m_SwitchLog.ObjectSwitchingPersistence; }
    ...
    bool LogBSESwitchLog(const T* const p_Binary, const bool p_PrimarySwitching, const bool p_IsMerger) {
        m_SwitchLog.PrimarySwitching = p_PrimarySwitching;
        m_SwitchLog.SwitchIsMerger   = p_IsMerger;        
...
// =============================================================================
// log_helpers - variadic-template implementations of the LogMacros.h families.
//
//
// Macros are split into a two-layer design:
//
//   1. THIS NAMESPACE - variadic-template functions doing the actual work:
//      one or two functions per family, args are comma-separated
//      (`dbg("Value: ", val)`), compile-time DEBUG / DEBUG_WARNINGS gating
//      uses `if constexpr` on a constexpr bool flag.
//
//   2. THIN MACRO WRAPPERS in LogMacros.h that gate via #ifdef. Same names
//      as the original macros (DBG, DBG_ID, ..., LOGV_ID_IF) but expand to
//      log_helpers:: calls when enabled and to ((void)0) when disabled.
//      The macros preserve the original compile-time-strip behaviour for
//      production builds (no call, no argument evaluation, no symbols).
//
// Developers can use either idiom:
//   DBG("Value: ", val)               - macro: compile-time stripped when off
//   log_helpers::dbg("Value: ", val)  - function: if-constexpr body, args still
//                                       evaluated
// The macro form is the production-friendly default. The function form is for
// callable contexts (callbacks, template parameters, etc.) where macro syntax
// doesn't fit.
//
// This namespace is defined at the bottom of Log.h (after `class Log`) because
// the templates call Log::Instance()->Method(). Two-phase template name
// lookup requires Log to be COMPLETE at the template-definition point for
// non-dependent names; a forward declaration is insufficient.
// =============================================================================
...
inline constexpr bool dbg_enabled =
#ifdef DEBUG
    true;
#else
    false;
...
inline constexpr bool dbg_warn_enabled =
...
// Build a string from variadic operator<< chains.
...
// Build "IN FUNCTION '<fn>'" + optional "\n" + stringified args.
template<typename... Args>
inline std::string stringify_id(const char* fn_name, Args&&... args) {
    std::stringstream ss;
    ss << "IN FUNCTION '" << fn_name << "'";
...
// -----------------------------------------------------------------------------
// DBG family (gated by constexpr dbg_enabled). Calls Log::Instance()->Debug.
// -----------------------------------------------------------------------------

template<typename... Args>
inline void dbg(Args&&... args) {
    if constexpr (dbg_enabled) Log::Instance()->Debug("", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void dbg_with(std::string cls, int level, Args&&... args) {
    if constexpr (dbg_enabled) Log::Instance()->Debug(std::move(cls), level, stringify(std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void dbg_if(Cond cond, Args&&... args) {
    if constexpr (dbg_enabled) if (cond) Log::Instance()->Debug("", 0, stringify(std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void dbg_if_with(Cond cond, std::string cls, int level, Args&&... args) {
    if constexpr (dbg_enabled) if (cond) Log::Instance()->Debug(std::move(cls), level, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void dbg_id_impl(const char* fn_name, Args&&... args) {
    if constexpr (dbg_enabled) Log::Instance()->Debug("", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void dbg_id_if_impl(const char* fn_name, Cond cond, Args&&... args) {
    if constexpr (dbg_enabled) if (cond) Log::Instance()->Debug("", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}

// DBG_WAIT calls DebugWait instead of Debug.
template<typename... Args>
inline void dbg_wait(Args&&... args) {
    if constexpr (dbg_enabled) Log::Instance()->DebugWait("", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void dbg_wait_with(std::string cls, int level, Args&&... args) {
    if constexpr (dbg_enabled) Log::Instance()->DebugWait(std::move(cls), level, stringify(std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void dbg_wait_if(Cond cond, Args&&... args) {
    if constexpr (dbg_enabled) if (cond) Log::Instance()->DebugWait("", 0, stringify(std::forward<Args>(args)...));
}

// -----------------------------------------------------------------------------
// DBG_WARN family (gated by constexpr dbg_warn_enabled). The original macros
// call Log::Instance()->Say (not Debug); we preserve that.
// -----------------------------------------------------------------------------

template<typename... Args>
inline void dbg_warn(Args&&... args) {
    if constexpr (dbg_warn_enabled) Log::Instance()->Say("", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void dbg_warn_with(std::string cls, int level, Args&&... args) {
    if constexpr (dbg_warn_enabled) Log::Instance()->Say(std::move(cls), level, stringify(std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void dbg_warn_if(Cond cond, Args&&... args) {
    if constexpr (dbg_warn_enabled) if (cond) Log::Instance()->Say("", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void dbg_warn_id_impl(const char* fn_name, Args&&... args) {
    if constexpr (dbg_warn_enabled) Log::Instance()->Say("", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void dbg_warn_id_if_impl(const char* fn_name, Cond cond, Args&&... args) {
    if constexpr (dbg_warn_enabled) if (cond) Log::Instance()->Say("", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}

// -----------------------------------------------------------------------------
// SAY family (always enabled).
// -----------------------------------------------------------------------------

template<typename... Args>
inline void say(Args&&... args) {
    Log::Instance()->Say("", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void say_with(std::string cls, int level, Args&&... args) {
    Log::Instance()->Say(std::move(cls), level, stringify(std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void say_if(Cond cond, Args&&... args) {
    if (cond) Log::Instance()->Say("", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void say_id_impl(const char* fn_name, Args&&... args) {
    Log::Instance()->Say("", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void say_id_if_impl(const char* fn_name, Cond cond, Args&&... args) {
    if (cond) Log::Instance()->Say("", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}
...
template<typename... Args>
inline void log_to(int logfileId, Args&&... args) {
    Log::Instance()->Put(logfileId, "", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void log_to_with(int logfileId, std::string cls, int level, Args&&... args) {
    Log::Instance()->Put(logfileId, std::move(cls), level, stringify(std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void log_if(int logfileId, Cond cond, Args&&... args) {
    if (cond) Log::Instance()->Put(logfileId, "", 0, stringify(std::forward<Args>(args)...));
}
template<typename... Args>
inline void log_id_impl(const char* fn_name, int logfileId, Args&&... args) {
    Log::Instance()->Put(logfileId, "", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}
template<typename Cond, typename... Args>
inline void log_id_if_impl(const char* fn_name, int logfileId, Cond cond, Args&&... args) {
    if (cond) Log::Instance()->Put(logfileId, "", 0, stringify_id(fn_name, std::forward<Args>(args)...));
}
...
template<typename... Args>
inline void logv(int logfileId, Args&&... args) {
    auto s = stringify(std::forward<Args>(args)...);
    Log::Instance()->Put(logfileId, "", 0, s);
    Log::Instance()->Say("", 0, s);
}
template<typename... Args>
inline void logv_with(int logfileId, std::string cls, int level, Args&&... args) {
    auto s = stringify(std::forward<Args>(args)...);
    Log::Instance()->Put(logfileId, cls, level, s);
    Log::Instance()->Say(std::move(cls), level, s);
}
template<typename Cond, typename... Args>
inline void logv_if(int logfileId, Cond cond, Args&&... args) {
    if (cond) {
        auto s = stringify(std::forward<Args>(args)...);
        Log::Instance()->Put(logfileId, "", 0, s);
        Log::Instance()->Say("", 0, s);
...
template<typename... Args>
inline void logv_id_impl(const char* fn_name, int logfileId, Args&&... args) {
    auto s = stringify_id(fn_name, std::forward<Args>(args)...);
    Log::Instance()->Put(logfileId, "", 0, s);
    Log::Instance()->Say("", 0, s);
}
template<typename Cond, typename... Args>
inline void logv_id_if_impl(const char* fn_name, int logfileId, Cond cond, Args&&... args) {
    if (cond) {
        auto s = stringify_id(fn_name, std::forward<Args>(args)...);
        Log::Instance()->Put(logfileId, "", 0, s);
        Log::Instance()->Say("", 0, s);
