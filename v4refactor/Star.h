...
public:
    ...
    STELLAR_TYPE              SwitchTo(const STELLAR_TYPE p_StellarType, bool p_SetStartingType = false, bool p_Log = true);
...
inline double CalculateCriticalMassRatio_Hurley2002() const                    { return m_Star->CalculateCriticalMassRatio_Hurley2002(); }
    ...
    inline double               CalculateCELambda_Nanjing() const                                              { return m_Star->CalculateCELambda_Nanjing(m_Star->Mass(), m_Star->Radius(), m_Star->CoreMass()); }
    ...
    inline bool                 EnvelopeExpelledByPulsations() const                                    { return m_Star->EnvelopeExpelledByPulsations(); }
    ...
    inline double               HeliumAbundanceCore() const                                                 { return m_Star->HeAbundanceCore(); }
    inline double               HeliumAbundanceSurface() const                                              { return m_Star->HeAbundanceSurface();} 
    inline double               HydrogenAbundanceCore() const                                               { return m_Star->HAbundanceCore(); }
    inline double               HydrogenAbundanceSurface() const                                            { return m_Star->HAbundanceSurface(); }
    inline double               InitialHeliumAbundance() const                                              { return m_Star->InitialHeAbundance(); }
    inline double               InitialHydrogenAbundance() const                                            { return m_Star->InitialHAbundance(); }
    ...
    inline bool                 IsOneOf(STELLAR_TYPE_LIST p_List) const                                     { return utils::IsOneOf(m_Star->StellarType(), p_List); }
    ...
    inline StellarSupernovaDetailsT SN_Details() const                                                      { return m_Star->SN_Details(); }
    ...
    inline double               Timescale(HURLEY_TIMESCALES p_Timescale) const                                      { return m_Star->Timescale(p_Timescale); }
    inline double               TotalMassLossRate() const                                                   { return m_Star->TotalMassLossRate(); }    
    inline bool                 IsMassAboveChandrasekhar() const                                            { return m_Star->IsMassAboveChandrasekhar(); }
    inline STELLAR_TYPE         ResolveAIC()                                                                { return m_Star->ResolveAIC(); }
    inline STELLAR_TYPE         ResolveSNIa()                                                               { return m_Star->ResolveSNIa(); }
    inline STELLAR_TYPE         ResolveHeSD()                                                               { return m_Star->ResolveHeSD(); }

    inline double               HeShell()      const                                                        { return m_Star->HeShell(); }
    inline double               HShell()       const                                                        { return m_Star->HShell(); }
    inline double               L0Ritter()     const                                                        { return m_Star->L0Ritter(); }
    inline double               LambdaRitter() const                                                        { return m_Star->LambdaRitter(); }
    inline double               XRitter()      const                                                        { return m_Star->XRitter(); }
    inline void                 SetHeShell(const double p_Value)                                            { m_Star->SetHeShell(p_Value); }
    inline void                 SetHShell(const double p_Value)                                             { m_Star->SetHShell(p_Value); }
    inline double               CalculateEtaH(const double p_MassIntakeRate)                                { return m_Star->CalculateEtaH(p_MassIntakeRate); }
    inline double               CalculateEtaHe(const double p_MassIntakeRate)                               { return m_Star->CalculateEtaHe(p_MassIntakeRate); }

    inline STELLAR_TYPE         EvolveToNextPhase()                                                         { return m_Star->EvolveToNextPhase(); }
    ...
    inline void                 SetMass(const double p_Mass)                                                { m_Star->SetMass(p_Mass); }
    inline void                 SetAge(const double p_Age)                                                  { m_Star->SetAge(p_Age); }

    inline void                 SetHasMTdonorHistory(const bool p_HasHistory)                                                       { m_Star->SetHasMTdonorHistory(p_HasHistory); }
    inline void                 SetMTdonorHistoryString(const StrT& p_Str)                                                          { m_Star->SetMTdonorHistoryString(p_Str); }
    ...
    inline double               CalculateConvectiveEnvelopeBindingEnergy(const double p_TotalMass, const double p_Radius, const double p_ConvectiveEnvelopeMass, const double p_Lambda) {
                                    return m_Star->CalculateConvectiveEnvelopeBindingEnergy_Hirai2022(p_TotalMass, p_Radius, p_ConvectiveEnvelopeMass, p_Lambda);
                                }
    ...
    inline MassLossT            CalculateMassLossValues(double p_Dt, const bool p_UpdateMDot = false)                               { return m_Star->CalculateMassLossValues(p_Dt, p_UpdateMDot); }

    inline double               CalculateMomentOfInertia() const                                                                    { return m_Star->CalculateMomentOfInertia(); }
    inline MT_CASE              DetermineMassTransferTypeAsDonor() const                                                                { return m_Star->DetermineMassTransferTypeAsDonor(); }
    ...
    inline double               CalculateTimescale_Thermal(const double p_Mass, const double p_Radius, const double p_Luminosity, const double p_CoreMass) const { return m_Star->CalculateTimescale_Thermal(p_Mass, p_Radius, p_Luminosity, p_CoreMass); }
    ...
    inline double               CalculateZetaAdiabatic_Hurley2002(const double p_Mass, const double p_CoreMass) const { return m_Star->CalculateZetaAdiabatic_Hurley2002(p_Mass, p_CoreMass); }
    inline double               CalculateZetaAdiabatic_Soberman1997(const double p_Mass, const double p_CoreMass) const { return m_Star->CalculateZetaAdiabatic_Soberman1997(p_Mass, p_CoreMass); }
...
inline double CalculateCriticalMassRatio_Ge2020_Interpolate(const double p_Mass, const double p_Radius, const double p_MTefficiency = 0.0) {
    ...
    inline STELLAR_TYPE         ResolveSupernova(bool p_HasMTdonorHistory = false)                                                  { return m_Star->ResolveSupernova(p_HasMTdonorHistory); }
...
private:
    ...
    std::unique_ptr<BaseStar> m_Star;           // pointer to star
