...
enum class ERROR: int {
    ...
    NO_OBJECT,                                                      // Object is null
    NO_REAL_ROOTS,                                                  // equation has no real roots
    NO_RNG,                                                         // random number generator not initialised
    ...
    UNEXPECTED_ECCENTRICITY_DISTRIBUTION,                           // Unexpected eccentricity distribution
    UNEXPECTED_END_OF_FILE,                                         // Unexpected end of file
    UNEXPECTED_EVOLUTION_MODE,                                      // Unexpected evolution mode
    UNEXPECTED_INITIAL_MASS_FUNCTION,                               // Unexpected IMF
    UNEXPECTED_KICK_DIRECTION_DISTRIBUTION,                         // Unexpected kick direction distribution
    UNEXPECTED_LOG_FILE_TYPE,                                       // Unexpected log file type
    UNEXPECTED_MASS_RATIO_DISTRIBUTION,                             // Unexpected mass ratio distribution
    UNEXPECTED_METALLICITY_DISTRIBUTION,                            // Unexpected metallicity distribution
    UNEXPECTED_ORBITAL_PERIOD_DISTRIBUTION,                         // Unexpected orbital period distribution
    ...
    UNEXPECTED_SEMI_MAJOR_AXIS_DISTRIBUTION,                        // Unexpected semi-major axis distribution
    ...
    UNEXPECTED_VROT_DISTRIBUTION,                                   // Unexpected rotational velocity distribution
    ...
    NO_VALUE,  // optional value not set
    NO_STATE,  // requested state (ZAMS/Previous) not stored
    STATE_HISTORY_CAPACITY_EXCEEDED,  // state history exceeded its fail-stop capacity (runaway system)
    EMPTY_MAP,  // empty map
    UNKNOWN_ORBITAL_PERIOD_DISTRIBUTION,  // unknown orbital period distribution
    UNKNOWN_METALLICITY_DISTRIBUTION,  // unknown metallicity distribution
    UNKNOWN_MASS_RATIO_DISTRIBUTION,  // unknown mass ratio distribution
    UNKNOWN_ECCENTRICITY_DISTRIBUTION,  // unknown eccentricity distribution
    UNKNOWN_EVOLUTION_MODE,                                          // unknown evolution mode
    ...
    UNKNOWN_LBV_ML_PRESCRIPTION,                             // unknown LBV mass loss prescription
    ...
    UNKNOWN_OB_ML_PRESCRIPTION,                              // unknown OB mass loss prescription
    ...
    UNKNOWN_MS_CORE_MASS_PRESCRIPTION,                              // unknown MS core mass prescription
    ...
    UNKNOWN_RSG_ML_PRESCRIPTION,                             // unknown RSG mass loss prescription
    ...
    UNKNOWN_VMS_ML_PRESCRIPTION,                             // unknown VMS mass loss prescription
    UNKNOWN_VROT_DISTRIBUTION,                                      // unknown rorational velocity distribution
    UNKNOWN_WR_ML_PRESCRIPTION,                              // unknown WR mass loss prescription
...
// ErrorEntry: the value type of the static error catalog. Replaces
// the previous `std::tuple<ERROR_SCOPE, std::string>`, so access sites
// can write `entry.text` instead of `std::get<1>(entry)`. The 164
// catalog entry initialisers (below) work unchanged - the inner
// `{ERROR_SCOPE::ALWAYS, "..."}` syntax is aggregate-init for either
// the old tuple or this struct.
struct ErrorEntry {
    ERROR_SCOPE scope;
    std::string text;
};

// `inline const` (C++17+) gives a single shared definition across all
// translation units that include this header. The previous bare `const`
// at namespace scope gave the variable internal linkage, so every TU
// got its own copy of all 164 entries.
inline const COMPASUnorderedMap<ERROR, ErrorEntry> ERROR_CATALOG = {
    ...
    { ERROR::NO_OBJECT,                                             { ERROR_SCOPE::ALWAYS,              "Object pointer is null" }},
    { ERROR::NO_REAL_ROOTS,                                         { ERROR_SCOPE::ALWAYS,              "No real roots" }},
    { ERROR::NO_RNG,                                                { ERROR_SCOPE::ALWAYS,              "Random number generator not initialised" }},
    ...
    { ERROR::UNEXPECTED_ECCENTRICITY_DISTRIBUTION,                  { ERROR_SCOPE::ALWAYS,              "Unexpected eccentricity distribution" }},
    { ERROR::UNEXPECTED_END_OF_FILE,                                { ERROR_SCOPE::ALWAYS,              "Unexpected end of file" }},
    { ERROR::UNEXPECTED_INITIAL_MASS_FUNCTION,                      { ERROR_SCOPE::ALWAYS,              "Unexpected initial mass function" }},
    { ERROR::UNEXPECTED_KICK_DIRECTION_DISTRIBUTION,                { ERROR_SCOPE::ALWAYS,              "Unexpected kick direction distribution" }},
    { ERROR::UNEXPECTED_LOG_FILE_TYPE,                              { ERROR_SCOPE::ALWAYS,              "Unexpected log file type" }},
    { ERROR::UNEXPECTED_MASS_RATIO_DISTRIBUTION,                    { ERROR_SCOPE::ALWAYS,              "Unexpected mass ratio distribution" }},
    { ERROR::UNEXPECTED_METALLICITY_DISTRIBUTION,                   { ERROR_SCOPE::ALWAYS,              "Unexpected metallicity distribution" }},
    { ERROR::UNEXPECTED_ORBITAL_PERIOD_DISTRIBUTION,                { ERROR_SCOPE::ALWAYS,              "Unexpected orbital period distribution" }},
    ...
    { ERROR::UNEXPECTED_SEMI_MAJOR_AXIS_DISTRIBUTION,               { ERROR_SCOPE::ALWAYS,              "Unexpected semi-major axis distribution" }},
    ...
    { ERROR::UNEXPECTED_VROT_DISTRIBUTION,                          { ERROR_SCOPE::ALWAYS,              "Unexpected rotational velocity distribution" }},
    ...
    { ERROR::NO_VALUE,                                          { ERROR_SCOPE::ALWAYS,              "No value (optional not populated)" }},
    { ERROR::NO_STATE,                                          { ERROR_SCOPE::ALWAYS,              "No saved state (ZAMS / Previous not yet recorded)" }},
    { ERROR::STATE_HISTORY_CAPACITY_EXCEEDED,                   { ERROR_SCOPE::ALWAYS,              "State history capacity exceeded (runaway system - raise capacity, or set 0 for unbounded)" }},
    { ERROR::EMPTY_MAP,                                    { ERROR_SCOPE::ALWAYS,              "Empty map" }},
    { ERROR::UNKNOWN_ORBITAL_PERIOD_DISTRIBUTION,                                    { ERROR_SCOPE::ALWAYS,              "Unknown orbital period distribution" }},
    { ERROR::UNKNOWN_METALLICITY_DISTRIBUTION,                                    { ERROR_SCOPE::ALWAYS,              "Unknown metallicity distribution" }},
    { ERROR::UNKNOWN_MASS_RATIO_DISTRIBUTION,                                    { ERROR_SCOPE::ALWAYS,              "Unknown mass ratio distribution" }},
    { ERROR::UNKNOWN_ECCENTRICITY_DISTRIBUTION,                                    { ERROR_SCOPE::ALWAYS,              "Unknown eccentricity distribution" }},
    { ERROR::UNKNOWN_EVOLUTION_MODE,                            { ERROR_SCOPE::ALWAYS,              "Unknown evolution mode" }},
    ...
    { ERROR::UNKNOWN_LBV_ML_PRESCRIPTION,                    { ERROR_SCOPE::ALWAYS,              "Unknown LBV mass loss prescription" }},
    ...
    { ERROR::UNKNOWN_OB_ML_PRESCRIPTION,                     { ERROR_SCOPE::ALWAYS,              "Unknown OB mass loss prescription" }},
    { ERROR::UNKNOWN_MS_CORE_MASS_PRESCRIPTION,                     { ERROR_SCOPE::ALWAYS,              "Unknown MS core mass prescription" }},
    ...
    { ERROR::UNKNOWN_RSG_ML_PRESCRIPTION,                    { ERROR_SCOPE::ALWAYS,              "Unknown RSG mass loss prescription" }},
    ...
    { ERROR::UNKNOWN_VMS_ML_PRESCRIPTION,                    { ERROR_SCOPE::ALWAYS,              "Unknown VMS mass loss prescription" }},
    { ERROR::UNKNOWN_VROT_DISTRIBUTION,                             { ERROR_SCOPE::ALWAYS,              "Unknown rotational velocity distribution" }},
    ...
    { ERROR::UNKNOWN_WR_ML_PRESCRIPTION,                     { ERROR_SCOPE::ALWAYS,              "Unknown WR mass loss prescription" }}
};


// err_msg: look up an error message by ERROR id. Replaces the previous
// ERR_MSG(x) macro, which spelled `std::get<1>(ERROR_CATALOG.at(x))`.
// The ERR_MSG macro is preserved as a thin alias so existing call sites
// (Star.cpp, Log.h, Options.cpp) continue to compile unchanged.
inline const std::string& err_msg(ERROR e) { return ERROR_CATALOG.at(e).text; }
#define ERR_MSG err_msg                                    // backwards compatibility
