...
const COMPASUnorderedMap<TYPENAME, STR_STR> TYPENAME_LABEL = {
    ...
    { TYPENAME::CDOUBLE,          { "CDOUBLE",                "FLOAT"          }},
...
const COMPASUnorderedMap<PROGRAM_OPTION, std::string> PROGRAM_OPTION_LABEL = {
    ...
    { PROGRAM_OPTION::LBV_ML_PRESCRIPTION,                       "LBV_ML_PRESCRIPTION" },

    { PROGRAM_OPTION::MALTSEV_FALLBACK,                                 "MALTSEV_FALLBACK" },
    { PROGRAM_OPTION::MALTSEV_FALLBACK_FRACTION,                        "MALTSEV_FALLBACK_FRACTION" },
...
public:
  ANY_PROPERTY_TYPE operator()(STAR_PROPERTY     )    const { return ANY_PROPERTY_TYPE::T_STAR_PROPERTY;   }
  ANY_PROPERTY_TYPE operator()(STAR_1_PROPERTY   )    const { return ANY_PROPERTY_TYPE::T_STAR_1_PROPERTY; }
  ANY_PROPERTY_TYPE operator()(STAR_2_PROPERTY   )    const { return ANY_PROPERTY_TYPE::T_STAR_2_PROPERTY; }
  ANY_PROPERTY_TYPE operator()(SUPERNOVA_PROPERTY    ) const { return ANY_PROPERTY_TYPE::T_SUPERNOVA_PROPERTY; }
  ANY_PROPERTY_TYPE operator()(COMPANION_PROPERTY    ) const { return ANY_PROPERTY_TYPE::T_COMPANION_PROPERTY; }
  ANY_PROPERTY_TYPE operator()(BINARY_PROPERTY   )    const { return ANY_PROPERTY_TYPE::T_BINARY_PROPERTY; }
  ANY_PROPERTY_TYPE operator()(PROGRAM_OPTION    )     const { return ANY_PROPERTY_TYPE::T_PROGRAM_OPTION; }
};
...
const std::map<PROGRAM_OPTION, PROPERTY_DETAILS> PROGRAM_OPTION_DETAIL = {
    ...
    { PROGRAM_OPTION::LBV_ML_PRESCRIPTION,                               { TYPENAME::INT,        "PO_LBV_Mass_Loss_Prscrptn",                 "-",          4, 1 }},
