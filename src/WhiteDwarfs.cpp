 ...
 */
double WhiteDwarfs::CalculateMassLossRateHurley() const {
 ...
 */
DBL_DBL WhiteDwarfs::CalculateMassAcceptanceRate(const double p_DonorMassRate,  const double p_AccretorMassRate) const {
