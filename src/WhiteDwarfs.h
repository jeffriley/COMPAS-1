...
protected:
    ...
    DBL_DBL         CalculateMassAcceptanceRate(const double p_DonorMassRate,
                                                const double p_AccretorMassRate = 0.0 ) const;
    ...
    double          CalculateRadialExtentConvectiveEnvelope() const                                     { return BaseStar::CalculateRadialExtentConvectiveEnvelope(); }         // HeWD stars don't have a convective envelope
    ...
    void            EvolveOneTimestepPreamble() const                                                   { BaseStar::EvolveOneTimestepPreamble(); }                              // Default to BaseStar

    STELLAR_TYPE    EvolveToNextPhase() const                                                           { return BaseStar::EvolveToNextPhase(); }                               // Default to BaseStar
    ...
    STELLAR_TYPE    ResolveRemnantAfterEnvelopeLoss() const                                             { return BaseStar::ResolveRemnantAfterEnvelopeLoss(); }                 // Default to BaseStar

    STELLAR_TYPE    ResolveSkippedPhase() const                                                         { return BaseStar::ResolveSkippedPhase(); }                             // Default to BaseStar
    STELLAR_TYPE    ResolveSupernova() const                                                            { return BaseStar::ResolveSupernova(); }                                // Default to BaseStar
